...
class AssumeutxoTest(BitcoinTestFramework):
    ...
    def test_invalid_snapshot_scenarios(self, valid_snapshot_path):
        ...
        for [magic, name, real] in invalid_magics:
            ...
            if real:
                assert_raises_rpc_error(parsing_error_code, f"Unable to parse metadata: The network of the snapshot ({name}) does not match the network of this node (custom).", node.loadtxoutset, bad_snapshot_path)
            else:
    ...
    def test_headers_not_synced(self, valid_snapshot_path):
        for node in self.nodes[1:]:
            msg = "Unable to load UTXO snapshot: The base block header (3bb27e6f7166543430d14d8a4a839a59aef05f845d8e9a0c210901a597269d1b) must appear in the headers chain. Make sure all headers are syncing, and call loadtxoutset again."
    ...
    def test_snapshot_block_invalidated(self, dump_output_path):
        ...
        for height in [SNAPSHOT_BASE_HEIGHT, SNAPSHOT_BASE_HEIGHT - 1]:
            ...
            msg = "Unable to load UTXO snapshot: The base block header (3bb27e6f7166543430d14d8a4a839a59aef05f845d8e9a0c210901a597269d1b) is part of an invalid chain."
            assert_raises_rpc_error(-32603, msg, node.loadtxoutset, dump_output_path)
    ...
    def run_test(self):
        ...
        assert_equal(
            ...
            "a625f26daf3ac072480d23c14ee861bae40652bcf0d0c898a1a85f72a373de53")
