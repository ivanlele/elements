...
class AssumeutxoTest(BitcoinTestFramework):
    ...
    def test_headers_not_synced(self, valid_snapshot_path):
        for node in self.nodes[1:]:
            assert_raises_rpc_error(-32603, "The base block header (3bb27e6f7166543430d14d8a4a839a59aef05f845d8e9a0c210901a597269d1b) must appear in the headers chain. Make sure all headers are syncing, and call this RPC again.",
                                    node.loadtxoutset,
                                    valid_snapshot_path)
