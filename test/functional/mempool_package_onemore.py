...
class MempoolPackagesTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        val = replacement_tx.vout[0].nValue.getAmount() - 1000000
        replacement_tx.vout[0].nValue.setToAmount(val)
        ...
        fee_vout = len(replacement_tx.vout)
        new_fee = replacement_tx.vout[fee_vout - 1].nValue.getAmount() + 1000000
        replacement_tx.vout[fee_vout - 1].nValue.setToAmount(new_fee)
