...
class SendallTest(BitcoinTestFramework):
    ...
    def sendall_with_minconf(self):
        ...
        assert_equal(self.wallet.getbalance()['bitcoin'], 0)
    ...
    def sendall_spends_unconfirmed_change(self):
        ...
        assert_greater_than(self.wallet.getbalances()["mine"]["trusted"]["bitcoin"], 6)
    ...
    def sendall_spends_unconfirmed_inputs_if_specified(self):
        ...
        assert_equal(self.wallet.getbalances()["mine"]["untrusted_pending"]["bitcoin"], 17)
    ...
    def sendall_does_ancestor_aware_funding(self):
        ...
        self.wallet.syncwithvalidationinterfacequeue()
        assert_equal(self.wallet.getbalances()["mine"]["untrusted_pending"]["bitcoin"], 34)
        unspent = self.wallet.listunspent(minconf=0)[0]
    ...
    def sendall_fails_with_transaction_too_large(self):
        ...
        # create many inputs
        outputs = {self.wallet.getnewaddress(): 0.000025 for _ in range(1460)} # ELEMENTS reduced since our txs are bigger (reduced from coinselection changes in bitcoin/bitcoin#25729)
