...
class RpcCreateMultiSigTest(BitcoinTestFramework):
    ...
    def do_multisig(self, nkeys, nsigs, output_type, wallet_multi):
        ...
        rawtx = node2.createrawtransaction([{"txid": tx["txid"], "vout": tx["sent_vout"]}], [{out_addr: outval}, {"fee": "0.00002"}])
        ...
        if self.is_wallet_compiled():
            assert_equal(node2.getbalances()['mine']['trusted']['bitcoin'], node2_balance['bitcoin'] + outval)
