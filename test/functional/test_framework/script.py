...
def LegacySignatureMsg(script, txTo, inIdx, hashtype, enable_sighash_rangeproof=True):
...
def SegwitV0SignatureMsg(script, txTo, inIdx, hashtype, amount, enable_sighash_rangeproof=True):
...
def TaprootSignatureHash(*args, **kwargs):
    return TaggedHash("TapSighash/elements", TaprootSignatureMsg(*args, **kwargs))
