...
class MiniWallet:
    def __init__(self, test_node, *, mode=MiniWalletMode.ADDRESS_OP_TRUE, hrp="ert", tag_name=None):
        ...
        if mode == MiniWalletMode.RAW_OP_TRUE:
            ...
            self._address, self._taproot_info = create_deterministic_address_bcrt1_p2tr_op_true(hrp=hrp, explicit_internal_key=internal_key)
    ...
    def generate(self, num_blocks, **kwargs):
        ...
        kwargs.pop('called_by_framework', None)
        blocks = self._test_node.generatetodescriptor(num_blocks, self.get_descriptor(), called_by_framework=True, **kwargs)
