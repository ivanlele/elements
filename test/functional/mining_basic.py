...
DEFAULT_BLOCK_MIN_TX_FEE = 100  # default `-blockmintxfee` setting [sat/kvB] # ELEMENTS
...
class MiningTest(BitcoinTestFramework):
    ...
    def test_blockmintxfee_parameter(self):
        ...
        for blockmintxfee_sat_kvb in (DEFAULT_BLOCK_MIN_TX_FEE, 50, 500, 2500, 5000, 21000, 333333, 2500000): # ELEMENTS
            ...
            assert_equal(tx_with_min_feerate["fee"], get_fee(tx_with_min_feerate["tx"].get_vsize(), blockmintxfee_btc_kvb) * COIN)
            if blockmintxfee_btc_kvb > 0:
                ...
                assert_equal(tx_below_min_feerate["fee"], get_fee(tx_below_min_feerate["tx"].get_vsize(), lowerfee_btc_kvb) * COIN)
