...
class WalletMigrationTest(BitcoinTestFramework):
    ...
    def test_basic(self):
        ...
        assert_equal(basic1.getbalance()['bitcoin'], bal)
        ...
        assert_equal(basic1_restored_wi['balance']['bitcoin'], bal)
        ...
        assert_equal(basic2.getbalance()['bitcoin'], 0)
        ...
        for addr in [basic2_seed.p2pkh_addr, basic2_seed.p2wpkh_addr, basic2_seed.p2sh_p2wpkh_addr]:
            ...
            self.generate(self.master_node, 1)
            assert_equal(basic2.getbalance()['bitcoin'], basic2_balance)
    ...
    def test_multisig(self):
        ...
        assert_equal(multisig1.getbalances()["watchonly"]["trusted"]['bitcoin'], 10)
        ...
        assert_equal(multisig1.getbalance()['bitcoin'], 0)
        ...
        assert_equal(ms1_watchonly.getbalance()['bitcoin'], 10)
        ...
        assert_equal(ms1_solvable.getbalance()['bitcoin'], 0)
    ...
    def test_addressbook(self):
        ...
        self.generatetoaddress(self.master_node, nblocks=101, address=df_wallet.getnewaddress()) # ELEMENTS: fund df_wallet
    ...
    def test_migrate_raw_p2sh(self):
        ...
        assert_equal(wallet.getbalances()['watchonly']['trusted']['bitcoin'], 2)
        ...
        assert_equal(wallet.getbalances()['watchonly']['trusted']['bitcoin'], 5)
        ...
        assert_equal(wallet.getbalances()['mine']['trusted']['bitcoin'], 0)
    ...
    def test_conflict_txs(self):
        ...
        amt = Decimal("9.9998")
        fee = value - amt
        conflict_unsigned = self.master_node.createrawtransaction(inputs=[conflict_utxo], outputs=[{wallet.getnewaddress(): amt}, {"fee": fee}])
    ...
    def test_avoidreuse(self):
        ...
        assert_equal(balances["mine"]["trusted"]["bitcoin"], 0)
        assert_equal(balances["watchonly"]["trusted"]["bitcoin"], 0)
        ...
        self.generate(self.master_node, 1)
        balances = wallet.getbalances()
        assert_equal(balances["mine"]["used"]["bitcoin"], 1)
        # Reused watchonly will not show up in balances
        assert_equal(balances["watchonly"]["trusted"]["bitcoin"], 0)
        assert_equal(balances["watchonly"]["untrusted_pending"]["bitcoin"], 0)
        assert_equal(balances["watchonly"]["immature"]["bitcoin"], 0)
