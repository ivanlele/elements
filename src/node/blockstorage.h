...
private:
     ...
     */
    bool LoadBlockIndex(ChainstateManager& chainman, const std::optional<uint256>& snapshot_blockhash)
        EXCLUSIVE_LOCKS_REQUIRED(cs_main);
...
public:
    ...
    bool LoadBlockIndexDB(ChainstateManager& chainman, const std::optional<uint256>& snapshot_blockhash)
        EXCLUSIVE_LOCKS_REQUIRED(::cs_main);
