...
public:
    CTestNet4Params() {
        m_chain_type = ChainTypeMetaFrom(ChainType::TESTNET4);
        consensus.signet_blocks = false;
        consensus.signet_challenge.clear();
        consensus.nSubsidyHalvingInterval = 210000;
    ...
    explicit CRegTestParams(const RegTestOptions& opts)
    {
        ...
        m_assumeutxo_data = {
            ...
            },
            {
                ...
                .height = 299,
                .hash_serialized = AssumeutxoHash{uint256{"4f046c8d36732314b2ccd00be35232e7a211eb87b0fd8858f898f511bc7fae64"}},
                .m_chain_tx_count = 334,
                .blockhash = consteval_ctor(uint256{"3bb27e6f7166543430d14d8a4a839a59aef05f845d8e9a0c210901a597269d1b"}),
            },
        };
