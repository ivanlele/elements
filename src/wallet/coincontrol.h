...
private:
    ...
    //! ELEMENTS
    std::optional<CScriptWitness> m_pegin_witness;
...
public:
    ...
    // ELEMENTS
    void SetPeginWitness(const CScriptWitness& script_wit);
    std::optional<CScriptWitness> GetPeginWitness() const;
};
...
public:
    ...
    // ELEMENTS
    std::optional<CScriptWitness> GetPeginWitness(const COutPoint& outpoint) const;
